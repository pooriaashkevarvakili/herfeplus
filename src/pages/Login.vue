<template>
  <div class="row q-col-gutter-sm q-py-sm">
    ...
    <div
      class="col-md-3 col-xs-12 col-sm-12 col-md-3 offset-3 sidebar"
      style=""
    >
      <q-card class="my-card-login">
        <q-card-section>
          <div dir="rtl" class="q-mt-sm q-mr-sm">ورود</div>
        </q-card-section>
        <q-card-section>
          <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
            ...
            <div class="flex flex-center">
              <q-btn class="btn-login" @click="main()" label="ورود"> </q-btn>
            </div>
            ...
            <div style="margin-top: 2px" class="text-center">
              <svg
                class="q-mr-xs"
                width="29"
                height="28"
...
const password = ref("");
const main = () => {
  if (((username.value = "vira"), (password.value = "12345678"))) {
...
const error = computed(() => {
  return password.value === "" ? " " : "رمزعبور اشتباه است";
});
const name = ref(null);
const text = ref(null);
